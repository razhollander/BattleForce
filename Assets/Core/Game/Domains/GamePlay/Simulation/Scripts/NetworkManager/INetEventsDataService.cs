...
namespace Core.Game.Domains.GamePlay.Simulation.Scripts.NetworkManager
{
    public interface INetEventsDataService
    {
        ...
        CapacityDict<long, FixedUnorderedList<ActivateRockTalentNetEventS2C>> ActivateRockTalentNetEventsPerClient { get; }
        ...
        void AddStageEndNetEvent(int onTick, ushort winningTeamId, Dictionary<ushort, int> jemsWon, Dictionary<ushort, int> totalJems, ushort playerIdToFocusOn);
        ...
        void AddActivateRockTalentNetEvent(int onTick, ushort casterPlayerId);
        ...
        void AddMoleSpawnedNetEvent(int onTick, ushort moleId, System.Numerics.Vector2 position);
        void AddMoleHitNetEvent(int onTick, ushort moleId, ushort byPlayerId, ushort byTeamId, int teamMolesHitTotal);
        void AddMoleExpiredNetEvent(int onTick, ushort moleId);
