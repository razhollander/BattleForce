...
namespace Core.Game.Domains.GamePlay.Simulation.Scripts.NetworkManager
{
    public interface INetEventsDataService
    {
        ...
        void AddPlayerLockOnHeartTargetsChangedNetEvent(int onTick, ushort playerId, Core.Scripts.Utils.CustomCollections.FixedUnorderedList<ushort> targetHeartIds);
    }
}