...
namespace Core.Game.Domains.GamePlay.Simulation.Scripts.Services.PlayersForcesService
{
    public class PlayersVelocityService : IPlayersVelocityService
    {
        ...
        public void StepPlayerSpin(PlayerSpaceshipStateS2C playerSpaceshipState, float deltaTime)
        {
            // 1. Calculate the Damping Factor
            // SpinDampingPerSecond should be a value between 0 and 1 (e.g., 0.5 to lose 50% speed per second).
            float dampingFactor = MathF.Pow(_simulationGamePlayConfig.PlayerSpaceship.SpinDampingPerSecond, deltaTime);
        ...
        public void StepPlayerVelocity(PlayerSpaceshipStateS2C playerSpaceshipState, float deltaTIme)
        {
