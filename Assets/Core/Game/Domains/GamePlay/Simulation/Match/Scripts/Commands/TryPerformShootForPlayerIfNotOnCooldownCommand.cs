    ...
    public class TryPerformShootForPlayerIfNotOnCooldownCommand : BaseCommand, ICommandVoid
    {
        ...
        private void CreateBulletForPlayer(int processedTick, PlayerStateS2C playerModel)
        {
            ...
            var bullet = _matchDataService.AddBullet(playerModel.Id, spawnPosition,
                playerModel.Spaceship.Transform.Direction, _gamePlayConfigService.GamePlayConfig.PlayerBullet.MoveSpeed, _gamePlayConfigService.GamePlayConfig.PlayerBullet.Radius, processedTick);
