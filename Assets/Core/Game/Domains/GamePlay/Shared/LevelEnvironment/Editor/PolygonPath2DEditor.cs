...
using Core.Game.Domains.GamePlay.Shared.LevelEnvironment.Scripts;
using UnityEditor;
using UnityEngine;

namespace Core.Game.Domains.GamePlay.Shared.LevelEnvironment.Editor
{
    [CustomEditor(typeof(PolygonPath2D))]
    public class PolygonPath2DEditor : UnityEditor.Editor
    {
        PolygonPath2D _path;
        int _selected = -1;
