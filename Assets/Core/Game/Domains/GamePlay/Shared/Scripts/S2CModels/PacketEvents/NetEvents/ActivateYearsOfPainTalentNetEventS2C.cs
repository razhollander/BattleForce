...
namespace Core.Game.Domains.GamePlay.Shared.Scripts.S2CModels.PacketEvents.NetEvents
{
    public struct ActivateYearsOfPainTalentNetEventS2C : INetSerializable, IComparable<ActivateYearsOfPainTalentNetEventS2C>
    {
        ...
        public ActivateYearsOfPainTalentNetEventS2C(int occuredOnTick, ushort casterPlayerId, Vector2 direction, int talentCooldownEndTick, bool hasHit, ushort hitEnemyId)
        {
