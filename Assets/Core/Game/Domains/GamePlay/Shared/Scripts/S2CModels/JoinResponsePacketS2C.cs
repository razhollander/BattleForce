...
namespace Core.Game.Domains.GamePlay.Shared.Scripts.S2CModels
{
    public class JoinResponsePacketS2C : INetSerializable
    {
        ...
        public JoinResponsePacketS2C(MaxCap maxCap, int maxTalentsPerPlayer, int maxTeams)
        {
            ...
            MatchSimulationState = new MatchSimulationStateS2C(maxCap.ConcurrentPlayers, maxCap.ConcurrentBullets, maxTalentsPerPlayer, maxCap.ConcurrentTalentCards, maxCap.ConcurrentPowerUpBalls, maxTeams, maxCap.ConcurrentChickenEggs, maxCap.ConcurrentGalacticForceFields, maxCap.ConcurrentFrigidBlocks, maxCap.ConcurrentMoles);
