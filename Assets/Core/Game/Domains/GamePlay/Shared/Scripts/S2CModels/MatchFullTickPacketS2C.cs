...
namespace Core.Game.Domains.GamePlay.Shared.Scripts.S2CModels
{
    public class MatchFullTickPacketS2C : INetSerializable
    {
        ...
        public void Serialize(NetDataWriter writer)
        {
            ...
            if ((eventMask & (1UL << 40)) != 0) SerializedActivateRockTalentNetEvents(writer);
            if ((eventMask & (1UL << 41)) != 0) SerializedDeactivateRockTalentNetEvents(writer);
        }
        ...
        public void Deserialize(NetDataReader reader)
        {
            ...
            if ((eventMask & (1UL << 40)) != 0) DeserializedActivateRockTalentNetEvents(reader);
            else ActivateRockTalentNetEvents.Clear();
            
            if ((eventMask & (1UL << 41)) != 0) DeserializedDeactivateRockTalentNetEvents(reader);
