...
namespace Core.Game.Domains.GamePlay.Presentation.Scripts.PresentationEvents
{
    public class CachedPresentationEventsService : ICachedPresentationEventsService
    {
        ...
        public List<PlayerStartedExposedToLavaNetEventS2C> PlayerStartedExposedToLavaNetEvents { get; } = new();
        ...
        public List<ActivateFrozenTalentNetEventS2C> ActivateFrozenTalentNetEvents { get; } = new();
        public List<DeactivateFrozenTalentNetEventS2C> DeactivateFrozenTalentNetEvents { get; } = new();
        ...
        public List<PlayerSetMoveDestinationPointNetEventS2C> PlayerSetMoveDestinationPointNetEvents { get; } = new();
