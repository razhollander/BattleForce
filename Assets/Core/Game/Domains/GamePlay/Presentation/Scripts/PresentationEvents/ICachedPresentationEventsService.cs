...
namespace Core.Game.Domains.GamePlay.Presentation.Scripts.PresentationEvents
{
    public interface ICachedPresentationEventsService
    {
        ...
        List<MoleKilledNetEventS2C> MoleKilledNetEvents { get; }
        List<PlayerPassedScoreGateNetEventS2C> PlayerPassedScoreGateNetEvents { get; }
        ...
        List<PlayerSetMoveDestinationPointNetEventS2C> PlayerSetMoveDestinationPointNetEvents { get; }
