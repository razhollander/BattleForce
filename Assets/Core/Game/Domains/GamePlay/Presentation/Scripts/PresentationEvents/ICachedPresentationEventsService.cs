...
namespace Core.Game.Domains.GamePlay.Presentation.Scripts.PresentationEvents
{
    public interface ICachedPresentationEventsService
    {
        ...
        List<Core.Game.Domains.GamePlay.Shared.S2CModels.PacketEvents.NetEvents.EnvironmentSpikePlayerCollisionNetEventS2C> EnvironmentSpikePlayerCollisionNetEvents { get; }
