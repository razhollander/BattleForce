...
namespace Core.Game.Domains.GamePlay.Presentation.MatchMaking.Scripts.Network.PacketsHandlers
{
    public class PresentationMatchMakingNetEventsHandler
    {
        ...
        public PresentationMatchMakingNetEventsHandler(IMatchMakingDataService matchDataService,
            ...
            IClientMatchMakingPresentationTickProcessor clientPresentationTickProcessor, ICommandFactory commandFactory)
        {
        ...
        public void ProcessPlayerJoinedEvents(CapacityList<MatchMakingPlayerJoinAcceptPacketS2C> playerJoinAcceptNetEvents, ref int clientTick)
        {
        ...
        private void SyncTickToServer(out int clientTick, MatchMakingPlayerJoinAcceptPacketS2C playerJoinAcceptNetEvent)
        {
