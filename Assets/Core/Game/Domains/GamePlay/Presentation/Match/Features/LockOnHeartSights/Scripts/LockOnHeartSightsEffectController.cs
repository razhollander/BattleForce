...
namespace Core.Game.Domains.GamePlay.Presentation.Match.Features.LockOnHeartSights.Scripts
{
    public class LockOnHeartSightsEffectController : ILockOnHeartSightsEffectController
    {
        ...
        private readonly Dictionary<ushort, List<LockOnHeartSightEffectView>> _activeSights = new Dictionary<ushort, List<LockOnHeartSightEffectView>>();
        ...
        public LockOnHeartSightsEffectController(IMatchDataService matchDataService, IMatchPlayerControllers matchPlayerControllers, LockOnHeartSightEffectView prefab, DiContainer diContainer)
        {
        ...
        public void ManagedUpdate()
        {
            ...
            foreach (var kvp in _expectedSightsCount)
            {
                ...
                {
                    _activeSights[targetId] = new List<LockOnHeartSightEffectView>();
                }
