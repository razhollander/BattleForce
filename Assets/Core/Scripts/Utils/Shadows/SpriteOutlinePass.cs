...
public class SpriteOutlinePass : ScriptableRenderPass
{
    ...
    public SpriteOutlinePass(Material material, float outlineThickness, RenderPassEvent renderPassEvent)
    {
    ...
    public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
    {
        ...
        using (var builder = renderGraph.AddRasterRenderPass<PassData>("CustomSpriteOutlinePass", out var passData))
        {
